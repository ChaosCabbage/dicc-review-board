...
Elm.Dicc = Elm.Dicc || {};
Elm.Dicc.Model = Elm.Dicc.Model || {};
Elm.Dicc.Model.make = function (_elm) {
   "use strict";
   _elm.Dicc = _elm.Dicc || {};
   _elm.Dicc.Model = _elm.Dicc.Model || {};
   if (_elm.Dicc.Model.values)
   return _elm.Dicc.Model.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Dicc.Model",
   $List = Elm.List.make(_elm);
   var addReview = F2(function (reviewer,
   model) {
      return _U.replace([["reviews"
                         ,A2($List._op["::"],
                         reviewer,
                         model.reviews)]],
      model);
   });
   var init = F3(function (number,
   author,
   description) {
      return {_: {}
             ,author: author
   ...
   _elm.Dicc.Model.values = {_op: _op
                            ,init: init
                            ,addReview: addReview
                            ,Model: Model};
   return _elm.Dicc.Model.values;
...
Elm.Dicc = Elm.Dicc || {};
Elm.Dicc.Parse = Elm.Dicc.Parse || {};
Elm.Dicc.Parse.make = function (_elm) {
   "use strict";
   _elm.Dicc = _elm.Dicc || {};
   _elm.Dicc.Parse = _elm.Dicc.Parse || {};
   if (_elm.Dicc.Parse.values)
   return _elm.Dicc.Parse.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Dicc.Parse",
   $Dicc$Model = Elm.Dicc.Model.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $List = Elm.List.make(_elm),
   $Result = Elm.Result.make(_elm);
   var diccoder = A4($Json$Decode.object3,
   $Dicc$Model.init,
   A2($Json$Decode._op[":="],
   "number",
   $Json$Decode.string),
   ...
   "description",
   $Json$Decode.string));
   var constructDiccWithReviews = F2(function (dicc,
   reviews) {
      return A3($List.foldl,
      $Dicc$Model.addReview,
      dicc,
      reviews);
   });
   var metaDiccDecoder = A3($Json$Decode.object2,
   constructDiccWithReviews,
   A2($Json$Decode._op[":="],
   "dicc",
   diccoder),
   A2($Json$Decode._op[":="],
   ...
   _elm.Dicc.Parse.values = {_op: _op
                            ,parse: parse};
   return _elm.Dicc.Parse.values;
};
Elm.Dicc = Elm.Dicc || {};
Elm.Dicc.View = Elm.Dicc.View || {};
Elm.Dicc.View.make = function (_elm) {
   "use strict";
   _elm.Dicc = _elm.Dicc || {};
   _elm.Dicc.View = _elm.Dicc.View || {};
   if (_elm.Dicc.View.values)
   return _elm.Dicc.View.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Dicc.View",
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Dicc$Model = Elm.Dicc.Model.make(_elm),
   $ElementUtils = Elm.ElementUtils.make(_elm),
   $Graphics$Collage = Elm.Graphics.Collage.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $List = Elm.List.make(_elm),
   $Styles$Text = Elm.Styles.Text.make(_elm),
   $Text = Elm.Text.make(_elm);
   var viewReviews = function (reviews) {
      return $Graphics$Element.flow($Graphics$Element.down)(A2($List.map,
      function ($) {
         return $Graphics$Element.width(50)($Text.centered($Text.fromString($)));
      },
      reviews));
   };
   var doReviewText = function (alreadyReviewing) {
      return alreadyReviewing ? "Continue your review" : "Start reviewing this";
   };
   ...
   var verticalSpacer = A3($Graphics$Collage.collage,
   12,
   24,
   ...
   ,_0: 0
   ,_1: -12}))]));
   var containLeft = F2(function (w,
   element) {
      return A4($Graphics$Element.container,
      w,
      12 + $Graphics$Element.heightOf(element),
      $Graphics$Element.midLeft,
      element);
   });
   var background = $Color.white;
   var textFormat = $Styles$Text.format(20);
   var viewUsername = function (user) {
      return $Graphics$Element.width(60)(textFormat(user));
   };
   var viewNumber = function (n) {
      return $Graphics$Element.width(80)(textFormat(n));
   };
   var viewDescription = function (desc) {
      return textFormat(desc);
   };
   ...
   _v0) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var identifiers = $ElementUtils.flowMidline(_L.fromArray([viewUsername(model.author)
                                                                          ,verticalSpacer
                                                                          ,viewNumber(model.number)]));
                 var reviews = $ElementUtils.flowMidline(_L.fromArray([verticalSpacer
                                                                      ,viewReviews(model.reviews)]));
                 var remainingWidth = _v0._0 - $Graphics$Element.widthOf(reviews) - $Graphics$Element.widthOf(identifiers) - 20;
                 var description = _U.cmp(remainingWidth,
                 0) < 0 ? $Graphics$Element.empty : $ElementUtils.flowMidline(_L.fromArray([verticalSpacer
                                                                                           ,containLeft(remainingWidth)(viewDescription(model.description))]));
                 return $Graphics$Element.color(background)(containLeft(_v0._0)($ElementUtils.flowMidline(_L.fromArray([identifiers
                                                                                                                       ,description
                                                                                                                       ,reviews]))));
              }();}
         _U.badCase($moduleName,
         "between lines 23 and 48");
      }();
   });
   _elm.Dicc.View.values = {_op: _op
                           ,view: view};
   return _elm.Dicc.View.values;
};
Elm.Dict = Elm.Dict || {};
...
Elm.ElementUtils = Elm.ElementUtils || {};
Elm.ElementUtils.make = function (_elm) {
   "use strict";
   _elm.ElementUtils = _elm.ElementUtils || {};
   if (_elm.ElementUtils.values)
   return _elm.ElementUtils.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "ElementUtils",
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $List = Elm.List.make(_elm);
   var maxHeight = function (elements) {
      return $List.isEmpty(elements) ? 0 : $List.maximum(A2($List.map,
      $Graphics$Element.heightOf,
      elements));
   };
   var flowMidline = function (elements) {
      return function () {
         var height = maxHeight(elements);
         var contain = function (elm) {
            return A4($Graphics$Element.container,
            $Graphics$Element.widthOf(elm),
            height,
            $Graphics$Element.middle,
            elm);
         };
         var containers = A2($List.map,
         contain,
         elements);
   ...
   _elm.ElementUtils.values = {_op: _op
                              ,flowMidline: flowMidline};
   return _elm.ElementUtils.values;
};
...
Elm.ReviewBoard = Elm.ReviewBoard || {};
Elm.ReviewBoard.make = function (_elm) {
   "use strict";
   _elm.ReviewBoard = _elm.ReviewBoard || {};
   if (_elm.ReviewBoard.values)
   return _elm.ReviewBoard.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   screenWidth) {
      return function () {
         var text = A2($Styles$Text.format,
         textHeight,
         string);
         return A4($Graphics$Element.container,
         screenWidth,
         $Graphics$Element.heightOf(text),
         $Graphics$Element.midRight,
         text);
      }();
   });
   var welcome = F2(function (name,
   w) {
      return A3(formatRight,
      A2($Basics._op["++"],
      "Welcome, ",
      name),
      50,
   ...
   var username = _P.portIn("username",
   _P.incomingSignal(function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",
      v);
   }));
...
Elm.Styles.Text = Elm.Styles.Text || {};
Elm.Styles.Text.make = function (_elm) {
   "use strict";
   _elm.Styles = _elm.Styles || {};
   _elm.Styles.Text = _elm.Styles.Text || {};
   if (_elm.Styles.Text.values)
   return _elm.Styles.Text.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Styles.Text",
   $Basics = Elm.Basics.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Text = Elm.Text.make(_elm);
   var style = function (h) {
      return function () {
         var $default = $Text.defaultStyle;
         return _U.replace([["typeface"
                            ,_L.fromArray(["Century Gothic"
                                          ,"arial"
                                          ,"sans-serif"])]
                           ,["height",$Maybe.Just(h)]],
         $default);
   ...
   var format = F2(function (h,s) {
      return $Text.centered($Text.style(style(h))($Text.fromString(s)));
   });
   _elm.Styles.Text.values = {_op: _op
                             ,style: style
                             ,format: format};
   return _elm.Styles.Text.values;
};
